...
export const fieldBaseClass =
  "h-12 w-full rounded-input bg-background-warm px-3.5 text-body-sm text-text-warm-dark placeholder:text-text-default disabled:text-grey-450 disabled:cursor-not-allowed aria-invalid:ring-2 aria-invalid:ring-danger focus:outline-none focus:ring-2 focus:ring-grey-350";
...
export const textareaClass =
  "mt-2 w-full rounded-input bg-background-warm px-3.5 py-3 text-body-sm text-text-warm-dark placeholder:text-text-default disabled:text-grey-450 disabled:cursor-not-allowed aria-invalid:ring-2 aria-invalid:ring-danger focus:outline-none focus:ring-2 focus:ring-grey-350";
