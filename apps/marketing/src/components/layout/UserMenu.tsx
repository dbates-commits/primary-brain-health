  ...
  return (
    <div ref={wrapperRef} onBlur={handleBlur} className="relative">
      ...
      >
        ...
        <span className="font-body text-base font-medium tracking-tight text-grey-850">
          {firstName}
        </span>
        <PhosphorIcon
          name="CaretDown"
      ...
      {mounted && (
        <div
          ...
          inert={!open}
          className={cn(
            "absolute top-full right-0 z-50 mt-1.5 flex flex-col rounded-xl border border-border-default bg-background-default p-1 drop-shadow-[0px_8px_12px_rgba(0,0,0,0.08)]",
