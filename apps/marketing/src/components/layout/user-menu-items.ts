...
export const userMenuItemClass =
  "flex w-40 items-center rounded-lg px-3 py-2.5 text-left font-body text-base font-medium text-ink-strong transition-colors hover:bg-brand-default/6 hover:text-brand-default focus-visible:bg-brand-default/6 focus-visible:text-brand-default focus:outline-none";
