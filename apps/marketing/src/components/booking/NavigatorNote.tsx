...
export function NavigatorNote() {
  return (
    <Section
      className="bg-background-teal-subtle px-6 py-20 md:px-10 md:py-28"
      stagger={90}
    >
      <div className="mx-auto max-w-4xl text-center">
        ...
        <h2
          data-scroll-item
          className="text-balance font-headline text-3xl font-thin leading-[1.15] text-grey-850 md:text-4xl"
        >
          {TITLE}
        </h2>
        <p
