    ...
    <TinaMarkdown
      ...
      components={{
        ...
        h1: (props?: { children?: ReactNode }) => (
          <p className="text-sm font-bold text-grey-900">{props?.children}</p>
        ),
        ...
        ul: (props?: { children?: ReactNode }) => (
          <ul className="flex list-disc flex-col gap-2 pl-5 text-sm leading-normal text-grey-700">
            {props?.children}
          </ul>
        ),
        ol: (props?: { children?: ReactNode }) => (
          <ol className="flex list-decimal flex-col gap-2 pl-5 text-sm leading-normal text-grey-700">
            {props?.children}
          </ol>
        ),
