      ...
      <div className="mx-auto flex max-w-6xl flex-col items-stretch gap-10 lg:flex-row lg:gap-[60px]">
        ...
        <div className="flex flex-col gap-4 lg:flex-1">
          <h2
            ...
            className="text-balance font-headline text-4xl font-thin leading-tight text-brand-on-brand md:text-5xl"
          >
            {headline}
          </h2>
          <p
            data-tina-field={tinaFields?.subheadline}
            className="text-pretty text-xl leading-relaxed text-text-inverse-secondary"
          >
            {subheadline}
          </p>
          <div className="mt-2">
