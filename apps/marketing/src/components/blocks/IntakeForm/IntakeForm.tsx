...
export function IntakeForm({
  ...
  const inputClasses =
    "w-full bg-background-warm border-none rounded-lg px-3 py-3 sm:px-4 sm:py-4 text-grey-850 focus:ring-2 focus:ring-focus-ring focus:outline-none";
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
        ...
        <div className="flex flex-col">
          ...
          {subheadline && (
            <p
              data-scroll-item
              className="text-text-inverse-secondary text-xl leading-relaxed mb-8 text-pretty"
          ...
          {showIncludes && (
            <div data-scroll-item className="p-6 sm:p-8 bg-brand-deep rounded-[1.25rem] flex-1 flex flex-col">
              <Heading as="h4" size="sm" className="mb-4 text-brand-on-brand">
                Includes:
              </Heading>
              <ul className="space-y-3 text-text-inverse-secondary">
                {[
              ...
              <div className="mt-10 pt-8 border-t border-brand-on-brand/15">
                <span className="text-3xl font-normal text-brand-on-brand font-headline">$149</span>
                <p className="text-text-inverse-secondary/60 text-sm mt-2">
                  This service may be eligible for{' '}
                  <span className="text-brand-on-brand">HSA/FSA reimbursement</span>
        ...
        {/* Right: Form */}
        <div data-scroll-item className="bg-background-default p-5 sm:p-8 md:p-10 rounded-[1.25rem] text-grey-850 shadow-lg">
