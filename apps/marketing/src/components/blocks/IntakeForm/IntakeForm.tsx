...
export function IntakeForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const data = {
      ...
      yearOfBirth: (form.elements.namedItem("yearOfBirth") as HTMLSelectElement).value,
      gender: (form.elements.namedItem("gender") as HTMLSelectElement).value,
      educationLevel: (form.elements.namedItem("educationLevel") as HTMLSelectElement).value,
    };
  ...
  return (
    <Section id="intake" className="py-16 md:py-32 px-6 md:px-10 bg-primary text-on-primary">
      <div className="max-w-6xl mx-auto">
        {/* Headline and subheadline run the section's full width, above the
            two panels rather than beside the form. */}
        {headline && (
          <h2
            data-scroll-item
        ...
        {subheadline && (
          <p
            data-scroll-item
            className="text-on-primary-container text-xl leading-relaxed mb-8 text-pretty max-w-4xl"
        ...
        {/* Includes panel and form card: grid siblings, so the row's default
            stretch gives them the same height. */}
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
          {showIncludes && (
            ...
            <div
              data-scroll-item
              className="flex h-full flex-col gap-10 rounded-[1.25rem] bg-brand-850 p-6 sm:p-8"
            >
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                <div>
                  <label htmlFor="yearOfBirth" className="block text-sm font-semibold mb-2">
                    Year of Birth
                  </label>
              ...
              <div>
                <label htmlFor="educationLevel" className="block text-sm font-semibold mb-2">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="Associates (2 years)">Associates (2 years)</option>
                    <option value="Bachelors (4 years)">Bachelors (4 years)</option>
                    <option value="Masters (6 years)">Masters (6 years)</option>
                    <option value="Doctorate (8+ years)">Doctorate (8+ years)</option>
                  </select>
                  <svg
                    className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-on-surface-variant"
                    fill="none"
