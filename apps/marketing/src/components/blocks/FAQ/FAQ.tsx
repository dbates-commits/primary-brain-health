            ...
            <div data-scroll-item className="text-center max-w-3xl">
              {headline && (
                <h1
                  ...
                  className="font-headline font-thin text-4xl md:text-5xl lg:text-6xl leading-[1.15] text-grey-850 text-balance"
                >
                  {headline}
                </h1>
              )}
            ...
            {items.map((item, index) => {
              ...
              return (
                <div key={index} data-scroll-item>
                  ...
                  >
                    <span className="font-body text-lg md:text-xl font-medium text-grey-850 pr-4">
                      {item.question}
                    </span>
                    <span
                      className={cn(
                      ...
                      aria-hidden="true"
                    >
                      <span className="absolute top-1/2 left-0 right-0 h-px bg-grey-850 -translate-y-1/2" />
                      <span className="absolute left-1/2 top-0 bottom-0 w-px bg-grey-850 -translate-x-1/2" />
                    </span>
                  </button>
