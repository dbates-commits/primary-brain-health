  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
        ...
        <div className="flex flex-col">
          ...
          {subheadline && (
            <p
              ...
              className="text-text-inverse-secondary text-xl leading-relaxed text-pretty"
            >
              {subheadline}
            </p>
          )}
        ...
        <div
          data-scroll-item
          className="bg-background-default p-5 sm:p-8 md:p-10 rounded-[1.25rem] text-grey-850 shadow-lg"
        >
