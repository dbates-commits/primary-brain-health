...
export function StackSections({
  ...
  return (
    <section className="px-6 md:px-10 pt-20 md:pt-28 pb-6 md:pb-10">
        ...
        >
          ...
          {headline && (
            <h2
              ...
              className="font-headline font-thin text-grey-850 text-4xl md:text-5xl lg:text-6xl leading-[1.1] text-balance"
            >
              {headline}
            </h2>
          )}
          ...
          return (
            ...
            >
              <div
                ...
                className={cn(
                  "relative w-full bg-background-brand-subtle rounded-[1.25rem] shadow-[0_10px_20px_-16px_rgba(0,0,0,0.25)] overflow-hidden grid grid-cols-1 md:grid-cols-2 md:min-h-[440px] origin-center",
                    ...
                    {item.icon &&
                      (item.icon.includes("/") || item.icon.endsWith(".svg") ? (
                        ...
                        <PhosphorIcon
                          ...
                          aria-hidden="true"
                          weight="regular"
                          className="w-14 h-14 md:w-16 md:h-16 text-grey-850"
                        />
                      ))}
                    {item.title && (
                      <h3
                        data-tina-field={getItemField(i, "title")}
                        className="font-headline font-thin text-grey-850 text-3xl md:text-4xl leading-[1.15] text-balance"
                      >
                        {item.title}
                      </h3>
                    )}
