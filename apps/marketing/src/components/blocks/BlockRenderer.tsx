...
//   IntakeForm      — the only block that paints a ground of its own. The
//                     reveal lands on this wrapper, outside the block's
//                     `Section`, so it would carry the teal up with the
//                     content and open a white band above it for the length
//                     of the transition — a sliver on a desktop row, most of
//                     the screen on a phone. `IntakeForm` already marks its
//                     own children `data-scroll-item`, so it fades from
//                     inside without help.
