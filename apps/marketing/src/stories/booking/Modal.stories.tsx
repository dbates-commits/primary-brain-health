...
export const ClosesOnEscape: Story = {
  args: {
    children: <p className="pb-6 text-body-sm text-text-default">Press Escape.</p>,
  },
  play: async ({ args }) => {
...
export const ClosesOnCloseButton: Story = {
  args: {
    children: <p className="pb-6 text-body-sm text-text-default">Use the ✕.</p>,
  },
  play: async ({ args }) => {
    const body = within(document.body);
...
export const ClosesOnBackdropClick: Story = {
  args: {
    children: (
      <p className="pb-6 text-body-sm text-text-default">
...
export const ReopensFromTrigger: Story = {
  args: {
    children: <p className="pb-6 text-body-sm text-text-default">Close, then reopen.</p>,
  },
  ...
  args: {
    ...
    children: (
      <div className="pb-6 sm:pb-10">
        <p className="text-body-sm text-text-default">The step body.</p>
      </div>
    ),
  },
  play: async () => {
