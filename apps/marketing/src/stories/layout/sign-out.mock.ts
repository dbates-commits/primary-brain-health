 ...
 * story can import it. `UserMenu` submits it from a form — there is no prop
 * seam, because wiring sign-out *is* what the menu does — so `.storybook/main.ts`
 * aliases the module to this file.
 *
