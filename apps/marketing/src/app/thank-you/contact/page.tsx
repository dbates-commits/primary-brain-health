  ...
  return (
    <div className="flex-grow flex items-center justify-center px-6 py-24 md:py-32">
      <div className="w-full max-w-xl text-center">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 bg-brand-default text-brand-on-brand px-8 py-4 rounded-full font-body font-bold transition-all hover:brightness-110 shadow-lg"
        >
          Return Home
        </Link>
      </div>
